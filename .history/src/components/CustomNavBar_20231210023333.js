...
import { Navbar, NavbarBrand, Nav, NavItem, NavLink, NavbarToggler, Collapse,LogoSvg } from 'reactstrap';
import './CustomNavBar.css'; // Import your CSS file for custom styling
import {ReactComponent as LogoSvg} from '../logo.svg'; // Import your logo image
    ...
    return (
        <div>
            <Navbar {...args} color="light" expand="md" container="fluid" >
                <NavbarBrand href="/">
                    <LogoSvg alt="Logo" /> {/* Add your SVG component here */}
                </NavbarBrand>
